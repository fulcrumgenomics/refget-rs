#!/bin/bash
#
# Install git hooks for refget-rs development
#
...
echo "Installing git hooks for refget-rs..."

# Verify we're in the right place
if [[ ! -f "${REPO_ROOT}/Cargo.toml" ]]; then
    echo "Error: Must be run from the refget-rs repository"
    exit 1
fi
...
echo "  REFGET_PRECOMMIT_TEST=1 git commit"
echo ""
